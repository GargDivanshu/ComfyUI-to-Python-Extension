...
def main():
    ...
    with torch.inference_mode():
        ...
        checkpointloadersimple_4 = checkpointloadersimple.load_checkpoint(
            ckpt_name="Disney Pixar Cartoon type B/disneyPixarCartoon_v10.safetensors"
        )
        ...
        loadimage_14 = loadimage.load_image(
            image="editor/ComfyUI_temp_ymhzq_00001_.png"
        )

        vaeloader = VAELoader()
        vaeloader_26 = vaeloader.load_vae(
            vae_name="stabilityai/sd-vae-ft-mse-original/vae-ft-mse-840000-ema-pruned.safetensors"
        )
        ...
        controlnetloader_19 = controlnetloader.load_controlnet(
            control_net_name="lllyasviel/ControlNet-v1-1/control_v11f1p_sd15_depth.pth"
        )
        ...
        controlnetloader_29 = controlnetloader.load_controlnet(
            control_net_name="lllyasviel/ControlNet-v1-1/control_v11p_sd15_lineart.pth"
        )
